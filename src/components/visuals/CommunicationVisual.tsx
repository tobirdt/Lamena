    ...
    >
      ...
      <g clipPath="url(#cv-lens)">
        <g className="pf-fade" style={i(2.4)} clipPath="url(#cv-lens-b)">
          <circle cx={BX} cy={CY} r={R} fill="rgba(139,102,184,0.08)" />
      ...
      <line
        ...
        pathLength={1}
        stroke="rgba(240,238,255,0.26)"
        strokeWidth="0.8"
      />
      <g className="pf-fade" style={i(2.2)} stroke="rgba(240,238,255,0.3)" strokeWidth="0.8">
      ...
      <g className="pf-fade" style={i(2.6)}>
        <circle cx={AX} cy={CY} r="2.6" fill="#8b66b8" />
        <circle cx={BX} cy={CY} r="2.6" fill="#8b66b8" />
      </g>

      {/* Distance leader below */}
      <g className="pf-fade" style={i(2.8)} stroke="rgba(240,238,255,0.22)" strokeWidth="0.7">
